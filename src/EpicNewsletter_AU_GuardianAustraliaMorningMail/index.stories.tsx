...
export default {
    component: 'EpicNewsletter_AU_GuardianAustraliaMorningMail',
    title: 'EndOfArticle/EpicNewsletter_AU_GuardianAustraliaMorningMail',
    parameters: {},
    argTypes: {
        ...coreArgTypes,
...
DefaultStory.storyName = 'EpicNewsletter_AU_GuardianAustraliaMorningMail';
