...
export default {
    component: 'EpicNewsletter_UK_TheMorningBriefing',
    title: 'EndOfArticle/EpicNewsletter_UK_TheMorningBriefing',
    parameters: {
        articleContext: {
            disable: false,
        },
...
DefaultStory.args = {
    ...
    header: 'Sign up for First Edition',
    frequency: 'Every weekday',
    paragraph1:
        'Our morning email breaks down the key stories of the day, telling you what’s happening and why it matters.',
    paragraph2:
        'We thought you should know this newsletter may contain information about Guardian products and services.',
    componentName: 'EpicNewsletter_UK_TheMorningBriefing',
    ophanComponentId: 'example_ophan_component_id',
};

DefaultStory.storyName = 'EpicNewsletter_UK_TheMorningBriefing';
